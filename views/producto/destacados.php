...
<div class="grid grid-cols-4 mt-5 gap-5 px-4">
    <div class="flex flex-col items-center gap-1.5">
        <img src="<?=BASE_URL?>/assets/img/PS5%20-%20Spiderman.png" alt="Spider-Man: Miles Morales" class="h-80">
    ...
    <div class="flex flex-col items-center gap-1.5">
        <img src="<?=BASE_URL?>/assets/img/Xbox%20-%20Red%20Dead%20Redemption%20II.png" alt="Red Dead Redemption 2"
             class="h-80">
    ...
    <div class="flex flex-col items-center gap-1.5">
        <img src="<?=BASE_URL?>/assets/img/Switch%20-%20The%20Legend%20of%20Zelda%20Breath%20of%20the%20Wild.png"
    ...
    <div class="flex flex-col items-center gap-1.5">
        <img src="<?=BASE_URL?>/assets/img/3DS%20-%20Animal%20Crossing%20New%20Leaf.png" alt="Animal Crossing: New Leaf"
             class="h-80">
